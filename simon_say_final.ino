...
designated pins. LEDs will be set up as follows:
  - Red LED goes with button 1 and ties to pin 8
  - Yellow LED goes with button 2 and ties to pin 9
  - Green LED goes with button 3 and ties to pin 10
  - Blue LED goes with button 4 and ties to pin 11
...
The LCD will the connected as follows:
  ...
  - LCD D4 pin to digital pin 16 (analog in 2)
  - LCD D5 pin to digital pin 17 (analog in 3)
  - LCD D6 pin to digital pin 18 (analog in 4)
  - LCD D7 pin to digital pin 19 (analog in 5)
